...
ENEMY_CONFIG = {
    ...
    ENEMY_CHARGER:  {"width": 30, "height": 30, "hp": 50,  "speed": 2.0, "gold": 5,  "damage": 22, "color": CHARGER_PURPLE},
    ENEMY_SPLITTER: {"width": 34, "height": 34, "hp": 35,  "speed": 2.2, "gold": 4,  "damage": 15, "color": SPLITTER_TEAL},
}
